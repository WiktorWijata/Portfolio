...
export const PageIntroVariant = {
  /** Projekty and Portfolio.cs: title line height 1.15, colour content-primary, accent on the last part. */
  Overview: 'overview',
  /** Stack and Experience: line height 1.04, colour content-strong, no accent on the last part. */
  Section: 'section',
