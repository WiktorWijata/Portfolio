    ...
    <div className="@container min-w-0 px-[26px] pt-5 pb-[26px] @max-[700px]:p-5">
      ...
      <div>
        {groups.map((group) => (
          <section
            key={group.id}
            className="grid grid-cols-[130px_minmax(0,1fr)] gap-4 border-b border-b-line-faint py-4 last:border-b-0 last:pb-0 @max-[560px]:grid-cols-1 @max-[560px]:gap-2"
          >
            <Text
              as="h3"
              ...
              className="mt-[3px] leading-[normal] tracking-[.1em] text-content-faint uppercase"
            >
              {group.label}
            </Text>
