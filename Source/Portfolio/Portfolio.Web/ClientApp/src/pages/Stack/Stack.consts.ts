...
export const STACK_GROUPS: TechnologyGroup[] = [
  ...
  },
  {
    ...
    label: 'AI',
    technologies: [
      { name: 'GitHub Copilot', icon: simpleIcon('githubcopilot'), monochrome: true },
      { name: 'Claude Code', icon: simpleIcon('claude') },
      { name: 'Cursor', icon: simpleIcon('cursor'), monochrome: true },
  ...
  },
  {
    ...
    technologies: [
      ...
      { name: 'GitHub', icon: simpleIcon('github'), monochrome: true },
