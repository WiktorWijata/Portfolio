    ...
    preview: (
      <div className="w-full">
        <Text as="div" size={FontSize.XSmall} font={FontFamily.Mono} color={TextColor.Accent}>
          visitor@portfolio:~$ <span className="text-content-primary">help</span>
        </Text>
    ...
    preview: (
      <div className="flex w-full flex-col gap-1.5">
        <Text
          ...
          className="max-w-[80%] rounded-[3px_12px_12px_12px] border border-line-default bg-surface-hover px-2.5 py-1.5 text-content-body"
        >
          Cześć! Pomogę Ci…
        </Text>
        <Text
          as="div"
          size={FontSize.XSmall}
          className="max-w-[80%] self-end rounded-[12px_3px_12px_12px] border border-chat-user-line bg-accent-surface px-2.5 py-1.5 text-content-primary"
        >
          Jakie ma doświadczenie?
        </Text>
      </div>
  ...
  >
    ...
    preview: (
      <Text
        ...
        className="flex items-center gap-[9px] rounded-xl-plus border border-accent-line bg-accent-surface px-4 py-[11px] text-content-strong shadow-launcher"
      >
