...
function ListDemo() {
  ...
  return (
    <div className="flex flex-wrap items-start gap-4">
      <List header="Stanowiska" count={3} className="w-[360px] overflow-hidden rounded-md border border-border">
      ...
      <List
        ...
        className="w-[260px] overflow-hidden rounded-md border border-border"
      >
    ...
    preview: (
      <div className="flex flex-col items-center gap-1.5">
        ...
        <div className="flex gap-1">
          ...
          <span className="size-1.5 rounded-full bg-[#60616a]" />
          <span className="size-1.5 rounded-full bg-[#60616a]" />
        </div>
      </div>
    ),
