...
export function IntroCopy() {
  ...
  return (
    <div className="flex min-w-0 flex-col self-stretch">
      <Text size={FontSize.XSmall} font={FontFamily.Mono} className="tracking-[1.2px] text-text-label uppercase">
        {HOME_KICKER}
      </Text>
      <div className="mt-[15px]">
        <Text
          ...
          className="mt-3 mb-2 text-[43px] leading-[1.04] tracking-[-.03em] text-text max-bp850:text-[36px] max-bp570:text-[39px]"
        >
          {HOME_TITLE_LEAD} <span className="text-accent">{HOME_TITLE_ACCENT}</span>
        </Text>
        <Text as="p" size={FontSize.Medium} font={FontFamily.Sans} className="leading-[1.8] text-text-lead">
          {HOME_TEXT}
        </Text>
