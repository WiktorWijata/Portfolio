...
export function GuideArticle({ article, onAction }: GuideArticleProps) {
  ...
  return (
    ...
    >
      <div
        className={[
          'aspect-[1.5/1] overflow-hidden rounded-sm border border-card-line bg-editor max-[480px]:w-full max-[480px]:max-w-[260px]',
      ...
      <div className="flex min-w-0 flex-col">
        <Text
          ...
          className="mt-px mb-2.5 text-[18px] leading-[1.35] text-[#e9e7ef]"
        >
          {article.title}
        </Text>
        {article.paragraphs.map((paragraph) => (
          <Text
            ...
            font={FontFamily.Sans}
            className="leading-[1.65] text-text-body"
          >
