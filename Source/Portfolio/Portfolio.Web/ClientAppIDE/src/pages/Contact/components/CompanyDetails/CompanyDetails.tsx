  ...
  return (
    <div className="flex w-max max-w-full min-w-0 flex-col gap-3.5 @max-[650px]:w-full">
      ...
      <Text
        ...
        className="w-max max-w-full leading-[1.8] break-words text-text-lead @max-[650px]:w-auto"
      >
        {DIRECT_TEXT}{' '}
        <a
          href={`mailto:${DIRECT_EMAIL}`}
          className="text-accent outline-none hover:underline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-accent"
        >
