...
export function Rail() {
  ...
  return (
    <nav
      ...
      className="flex flex-col items-center gap-[7px] border-r border-border bg-hover py-3 max-bp570:hidden"
    >
      <RailButton
        className="pb-[9px]"
      ...
      <RailButton
        ...
        onClick={toggleChat}
      />
      <div aria-hidden className="my-0.5 h-px w-[27px] bg-border" />
